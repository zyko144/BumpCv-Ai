...
export default function Home({ setView }: { setView: (v: 'upload' | 'editor' | 'pricing') => void }) {
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="flex items-center gap-2 bg-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20"
            >
              Créer de zéro
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-white text-neutral-900 px-8 py-4 rounded-full font-semibold hover:bg-neutral-50 transition-colors shadow-sm border border-neutral-200"
            >
              Voir les offres
            </button>
          </div>
        ...
        >
          ...
          >
            ...
            <p className="text-neutral-500 mb-8 max-w-xs">
              Cliquez ou déposez votre vieux PDF ici. L'IA s'occupe du reste.
            </p>
          ...
          <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} className="absolute -top-6 -right-6 glass rounded-2xl p-4 flex items-center gap-3 shadow-xl">
            <div className="w-10 h-10 bg-purple-500/10 rounded-xl flex items-center justify-center text-purple-600"><LayoutTemplate className="w-5 h-5" /></div>
            <div className="text-left"><p className="text-sm font-bold text-neutral-900">Designs Premium</p><p className="text-xs text-neutral-500">12 modèles</p></div>
          </motion.div>

          <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }} className="absolute -bottom-8 -left-8 glass rounded-2xl p-4 flex items-center gap-3 shadow-xl">
            <div className="w-10 h-10 bg-emerald-500/10 rounded-xl flex items-center justify-center text-emerald-600"><Briefcase className="w-5 h-5" /></div>
            <div className="text-left"><p className="text-sm font-bold text-neutral-900">Mots-clés ATS</p><p className="text-xs text-neutral-500">Optimisation IA</p></div>
          </motion.div>
        </motion.div>
      </div>
    </main>
